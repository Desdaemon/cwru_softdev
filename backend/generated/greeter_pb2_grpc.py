...
class TripsStub(object):
    ...
    def __init__(self, channel):
        ...
        self.addPhoto = channel.unary_unary(
                '/Trips/addPhoto',
                request_serializer=greeter__pb2.AddPhotoRequest.SerializeToString,
                response_deserializer=greeter__pb2.Result.FromString,
                )
...
def add_TripsServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'addPhoto': grpc.unary_unary_rpc_method_handler(
                    servicer.addPhoto,
                    request_deserializer=greeter__pb2.AddPhotoRequest.FromString,
                    response_serializer=greeter__pb2.Result.SerializeToString,
            ),
...
class Trips(object):
    ...
    def addPhoto(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Trips/addPhoto',
            greeter__pb2.AddPhotoRequest.SerializeToString,
            greeter__pb2.Result.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
