...
class UsersClient extends $grpc.Client {
  static final _$register =
      $grpc.ClientMethod<$0.RegisterRequest, $0.UserResponse>(
          '/Users/Register',
  ...
  $grpc.ResponseFuture<$0.UserResponse> register($0.RegisterRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$register, request, options: options);
  }

  $grpc.ResponseFuture<$0.UserResponse> login($0.LoginRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class UsersServiceBase extends $grpc.Service {
  ...
  $async.Future<$0.UserResponse> register_Pre(
  ...
  $async.Future<$0.UserResponse> register(
